...
* @route '/livewire-1b2f91c4/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-1b2f91c4/upload-file',
...
* @route '/livewire-1b2f91c4/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1b2f91c4/preview-file/{filename}',
